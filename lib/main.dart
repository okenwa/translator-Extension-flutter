...
import 'package:translate_extension/translate_page.dart';
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      theme: new ThemeData(
        ...
        fontFamily: "news-serif",
      ),
      home: new MyHomePage(title: 'Translator Extension'),
    );
  }
}
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            ...
                            IconButton(
                              icon: Icon(
                                IconData(0xe801, fontFamily: 'Trajan Pro'),
    ...
    return Row(
      children: <Widget>[
        SizedBox(
          height: 50.0,
          child: key == "ha"
              ? Image.asset("assets/flags/naija.png")
              : Image.asset("assets/flags/britain.png"),
        ...
        Padding(
          ...
          child: key == "ha" ? Text("Hausa") : Text("English"),
        )
      ],
    );
  }
  ...
  _buildRecnts() {
    return _recentTranlates.length <= 0
        ? Column(
            ...
            children: <Widget>[
              Icon(
                IconData(0xe804, fontFamily: 'Trajan Pro'),
